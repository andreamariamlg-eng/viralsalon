...
=== REGLAS DEL DIALOGO ===
1. GANCHO OBLIGATORIO EN LA PRIMERA LINEA DEL AVATAR: La primera frase del AVATAR es el hook de todo el video. Debe partir siempre del PROBLEMA DEL DIA A DIA de la clienta, no del miedo al tratamiento. La clienta no abre hablando de "me da miedo que se danen mis pestanas" sino del problema que tiene en su vida: "Estoy harta de levantarme mas pronto cada manana para maquillarme, que puedo hacer?" o "Me paso la vida con la cuchilla y no aguanto mas, hay algo mejor?" o "Llevo anos sin poder llevar el pelo suelto porque se me queda fatal". UN SOLO dolor, directo, del dia a dia. INCORRECTO: empezar hablando de miedo al tratamiento o de dudas tecnicas. INCORRECTO: acumular varios problemas. INCORRECTO: palabras medicas. CORRECTO: el problema que tiene la clienta cada manana al levantarse.
...
3. Las siguientes preguntas del AVATAR siguen la logica natural de la conversacion, cortas y directas como en un DM. Cuando la PROFESIONAL dice algo que sorprende o que resuelve un miedo, el AVATAR reacciona con emocion real antes de hacer la siguiente pregunta. No "creo que me animo" sino "No me digas 50 euros todo?! Quiero empezar ya, que tengo que hacer?" o "En serio tan rapido se nota?? Y cuanto cuesta?" La emocion tiene que ser autentica y proporcional a la sorpresa. El avatar no es neutral, es una persona que se va ilusionando con cada respuesta.
...
13. PROHIBIDO usar palabras en ingles. Nada de "shorts", "leggings", "look", "outfit", "top", "body", "lifting", "glow", "routine". Usa siempre el equivalente en espanol: pantalon corto, mallas, aspecto, conjunto, parte de arriba, hidratacion, brillo, rutina.
14. PROHIBIDO usar vocabulario clinico o medico que no usa nadie en una conversacion normal. Nada de "encarnadas", "foliculos", "epidermis", "irritacion cutanea". Si hay que decirlo, usa lenguaje de calle: "pelos que salen mal", "piel irritada", "la piel se irrita".
15. La conversacion tiene que ser SENCILLA y FLUIDA. No metas toda la informacion en un intercambio. Cada respuesta dice una sola cosa importante, no tres a la vez. Menos es mas.
16. DATO REAL SOBRE DEPILACION LASER: Si el servicio es depilacion laser, usa siempre datos reales y honestos: se recomiendan entre 8 y 10 sesiones, con una sesion al mes, aunque el numero exacto depende del tipo de vello y el tono de piel de cada persona. NUNCA digas "4 o 5 sesiones y te olvidas para siempre" porque no es cierto y genera expectativas falsas. Lo correcto es: "entre 8 y 10 sesiones segun tu vello, una al mes, y despues un mantenimiento puntual".
16b. USO CORRECTO DE HERRAMIENTAS — NUNCA CONFUNDAS: La CUCHILLA o MAQUINILLA es exclusivamente para depilar el cuerpo (piernas, axilas, bikini). NUNCA se usa para las pestañas ni el cabello. Para las pestañas se usa RIZADOR DE PESTANAS o RIMEL o MASCARA DE PESTANAS. Para el cabello se usa PLANCHA, RIZADOR DE PELO o TENACILLAS. Si el servicio es lifting de pestanas, el problema del avatar es "uso el rizador cada manana y no me dura nada" o "me echo rimel todos los dias y se me mancha". NUNCA "me rizo las pestanas con la cuchilla" porque eso no existe.
17. DATO REAL SOBRE LIFTING DE PESTANAS: Si el servicio es lifting de pestanas, NUNCA digas que no dana la pestana ni que es imposible que la queme o deteriore. La verdad honesta es: el lifting SI puede dañar la pestana si se hace con productos de mala calidad o con mala tecnica. Lo correcto es decir que con productos de alta calidad y una buena profesional, la pestana no se daña en absoluto. Ejemplo CORRECTO: "Con los productos que usamos aqui, de alta calidad, tu pestana no sufre nada. El riesgo viene cuando se hace con productos baratos o sin experiencia." NUNCA digas que es como rizarse el pelo o que no hay ningun riesgo. Siempre honesta, siempre con matiz de calidad del producto y la profesional.
18. NOMBRA EL SERVICIO EN EL DIALOGO: La PROFESIONAL debe nombrar claramente el servicio (lifting de pestanas, depilacion laser, botox capilar, etc.) en su primera o segunda respuesta. No des por hecho que quien lo ve sabe de que tratamiento se habla. El nombre del servicio tiene que aparecer de forma natural en la conversacion.
...
16. USO DE NOMBRES DE CLIENTAS: NO pongas nombre de clienta en todos los guiones. Los nombres solo son opcionales cuando el desarrollo es una historia real de una clienta concreta. Incluso en ese caso, la mitad de las veces NO uses nombre: di simplemente "el otro día vino una clienta", "hace unos meses vino una chica", "una clienta que lleva meses viniendo". Solo usa nombre cuando aporte cercanía real y no suene forzado. NUNCA uses siempre el mismo nombre ni pongas nombre en guiones que no sean historias reales (guiones educativos, de comparación, de mito destruido, etc.).
17c. USO CORRECTO DE HERRAMIENTAS — NUNCA CONFUNDAS: La CUCHILLA o MAQUINILLA es exclusivamente para depilar el cuerpo. NUNCA se usa para las pestanas ni el cabello. Para las pestanas: RIZADOR DE PESTANAS, RIMEL o MASCARA. Para el cabello: PLANCHA, RIZADOR o TENACILLAS. Si el servicio es lifting de pestanas, el problema es "uso el rizador cada dia" o "me echo rimel y no me dura". NUNCA "me rizo las pestanas con la cuchilla".
17b. DATO REAL SOBRE DEPILACION LASER: Si el servicio es depilacion laser, menciona siempre datos honestos: entre 8 y 10 sesiones recomendadas, una sesion al mes, y el resultado depende del tipo de vello y tono de piel. NUNCA digas que en 4 o 5 sesiones se elimina para siempre porque no es cierto para todo el mundo.
17. NOMBRA SIEMPRE EL SERVICIO CON CLARIDAD: En algún punto del guión, antes de terminar, tiene que quedar absolutamente claro QUÉ servicio o tratamiento es el que soluciona el problema. No des por hecho que la persona que ve el vídeo sabe de qué estás hablando. Ejemplo MALO: "Te han mentido. Se quita. De verdad." — ¿qué se quita? ¿con qué? No se entiende nada. Ejemplo BUENO: "Con la depilación láser el pelo se va reduciendo sesión a sesión hasta desaparecer. No es magia, es tecnología que funciona." El servicio tiene que aparecer nombrado de forma natural y clara, no escondido ni implícito."""
