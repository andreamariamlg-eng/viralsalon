...
=== REGLAS DEL DIALOGO ===
1. GANCHO OBLIGATORIO EN LA PRIMERA LINEA DEL AVATAR: La primera frase del AVATAR es el hook de todo el video. UN SOLO dolor concreto, expresado de forma directa como si se lo contara a una amiga. Que cualquier mujer que lo vea piense "eso me pasa a mi". Ejemplos CORRECTOS: "Estoy harta de depilarse con cuchilla, que me recomiendas?", "Llevo anos sin poder llevar el pelo suelto porque se me queda fatal", "Me da tanta verguenza ensenar las manos que siempre las escondo". INCORRECTO: acumular varios sintomas o problemas en la misma frase. INCORRECTO: empezar con algo educado o neutral. INCORRECTO: usar palabras medicas o clinicas como "encarnadas", "foliculos", "dermis". USA palabras del dia a dia.
